...
kotlin {
    ...
    val xcf = XCFramework("Whoami")

    macosArm64 {
        binaries.framework { baseName = "Whoami"; xcf.add(this) }
    }
    iosArm64 {
        binaries.framework {
            baseName = "Whoami"
    ...
    swiftExport {
        moduleName = "Whoami"
        flattenPackage = "io.github.kotlinmania.whoami"
    }

    android {
        namespace = "io.github.kotlinmania.whoami"
...
mavenPublishing {
    ...
    coordinates(group.toString(), "whoami-kotlin", version.toString())

    pom {
        name.set("whoami-kotlin")
        description.set("Kotlin Multiplatform port of ardaku/whoam - Rust library for getting information about the current user and environment")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/whoami-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/whoami-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/whoami-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/whoami-kotlin.git")
        }
    }
}
...
tasks.register<JavaExec>("codeqlCompileJvm") {
    ...
    doFirst {
        ...
        if (sourceFiles.isEmpty()) {
            val sentinelFile = sentinelDir.get().asFile.resolve("io/github/kotlinmania/whoami/codeql/_CodeqlEmptySource.kt")
            ...
            sentinelFile.writeText(
                ...
                package io.github.kotlinmania.whoami.codeql
...
val fullTargetBuildTaskNames = setOf(
    ...
    "assembleWhoamiXCFramework",
    "assembleWhoamiDebugXCFramework",
    "assembleWhoamiReleaseXCFramework",
    "assembleDebugIosFatFrameworkForWhoamiXCFramework",
    "assembleReleaseIosFatFrameworkForWhoamiXCFramework",
    "assembleDebugIosSimulatorFatFrameworkForWhoamiXCFramework",
    "assembleReleaseIosSimulatorFatFrameworkForWhoamiXCFramework",
    "assembleDebugMacosFatFrameworkForWhoamiXCFramework",
    "assembleReleaseMacosFatFrameworkForWhoamiXCFramework",
    "assembleDebugTvosFatFrameworkForWhoamiXCFramework",
    "assembleReleaseTvosFatFrameworkForWhoamiXCFramework",
    "assembleDebugTvosSimulatorFatFrameworkForWhoamiXCFramework",
    "assembleReleaseTvosSimulatorFatFrameworkForWhoamiXCFramework",
    "assembleDebugWatchosFatFrameworkForWhoamiXCFramework",
    "assembleReleaseWatchosFatFrameworkForWhoamiXCFramework",
    "assembleDebugWatchosSimulatorFatFrameworkForWhoamiXCFramework",
    "assembleReleaseWatchosSimulatorFatFrameworkForWhoamiXCFramework",
)
