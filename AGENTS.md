...
This file is the quick-reference operating contract for whoami-kotlin. The longer
...
whoami-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`whoami`](https://crates.io/crates/whoami). Upstream Rust is the behavioral oracle while the
