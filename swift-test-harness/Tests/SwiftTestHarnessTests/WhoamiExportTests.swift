...
// of the pipeline:
//
//   1. `embedSwiftExportForXcode` produced `Whoami.swiftmodule/`
...
//      `import Whoami` above would fail at compile time.
//
//   2. The static archive `libWhoami.a` (produced by the
...
//      architecture arm64".
//
//   3. The Kotlin `swiftExport { moduleName = "Whoami" }` and
//      `flattenPackage = "io.github.kotlinmania.whoami"` configuration in
